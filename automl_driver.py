...
workspace_name = "labai2" # PLACEHOLDER
subscription_id = "b44f9c09-539b-4dac-9ab2-1d4236968fa1" # PLACEHOLDER
resource_group = "lab2" # PLACEHOLDER
experiment_name = "bike_lunch_7rwl3fb1s2" # PLACEHOLDER
iteration = "2"  # PLACEHOLDER
run_id = "bike_lunch_7rwl3fb1s2_2"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/','subscription_id':'b44f9c09-539b-4dac-9ab2-1d4236968fa1','resource_group':'lab2','workspace_name':'labai2','iterations':3,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','IsImageTask':False,'IsTextDNNTask':False,'validation_size':0.1,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':3,'max_nodes':3,'iteration_timeout_minutes':15,'enforce_time_on_windows':False,'experiment_timeout_minutes':15,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':['RandomForest','LightGBM'],'blacklist_models':None,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':False,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':3,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'minimize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_type':'Standard_A2m_v2','vm_priority':'dedicated','label_column_name':'rentals','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','verbosity':20,'ensemble_iterations':3,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'subscription_id':'b44f9c09-539b-4dac-9ab2-1d4236968fa1','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"bike_lunch_7rwl3fb1s2_2\",\"experiment_name\":\"bike_lunch_7rwl3fb1s2\",\"workspace_name\":\"labai2\",\"subscription_id\":\"b44f9c09-539b-4dac-9ab2-1d4236968fa1\",\"resource_group_name\":\"lab2\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/westus/workspaces/a24dd143-e81d-4c9c-be48-21914381c7bc/data/aluguel-bicicletas/versions/1\",\"ResolvedUri\":\"azureml://locations/westus/workspaces/a24dd143-e81d-4c9c-be48-21914381c7bc/data/aluguel-bicicletas/versions/1\",\"AssetId\":\"azureml://locations/westus/workspaces/a24dd143-e81d-4c9c-be48-21914381c7bc/data/aluguel-bicicletas/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
